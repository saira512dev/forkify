...
class RecipeView extends _viewJsDefault.default {
    ...
    _generateMarkupIngredient(ing) {
        return `<li class="recipe__ingredient">\n  <svg class="recipe__icon">\n    <use href="${_iconsSvgDefault.default}#icon-check"></use>\n  </svg>\n  <div class="recipe__quantity">${ing.quantity ? new _helpersJs.numberToFraction(ing.quantity).toString() : ''}</div>\n  <div class="recipe__description">\n    <span class="recipe__unit">${ing.unit}</span>\n    ${ing.description}\n  </div>\n</li>`;
    }
}
exports.default = new RecipeView();

},{"./View.js":"8rtS4","url:../../img/icons.svg":"iwCpK","../helpers.js":"9l3Yy","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8rtS4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
